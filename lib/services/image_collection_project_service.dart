...
class ImageCollectionProjectService {
  List<ListCollectionProject> parseImageInCollectionList(
    ...
    for (int i = 0; i < count; i++) {
      imageList.add(ListCollectionProject.fromJson(
          list['listCollectionProject'][i]['imageList']));
    }
    return imageList;
  }

  Future<List<ListCollectionProject>> getImageInCollectionList(
      int index) async {
